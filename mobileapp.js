...
function insert_city_events( )
{
    ...
    if( citydata[1] != '' ) {
	$("#mytodaylist").append( "<tr class='listitem'><td class='message1' colspan=2 onclick='showabout( );' style='padding: 5px;'>"
				  + citydata[1] + "</td></tr>" );
    }
    if( citydata[2] != '' ) {
	$("#mytodaylist").append( "<tr class='listitem'><td class='message2' colspan=2 onclick='showabout( );' style='padding: 5px;'>"
				  + citydata[2] + "</td></tr>" );
    }
